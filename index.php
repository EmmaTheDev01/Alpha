...
<title>Book your ticket on Alpha Express Bus online.</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="banner_content">
            <h1 class='banner-content'>You are one click away from starting your journey.</h1>
            <p class="Hero-paragraph">Book your ticket online, with Alpha Express, and enjoy your trips around the country sides. </p>
            <a href="car-listing.php"><button class="btn">Book Now</button></a>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>You can get to book a ticket online on your phone or computer without moving from home, it's easy and reliable. Get your ticket and book your seats.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Available tickets</a></li>
        </ul>
      </div>
...
<li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> Years</li>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>12000+</h2>
            <p>Customers</p>
          </div>
        </div>
      </div>
