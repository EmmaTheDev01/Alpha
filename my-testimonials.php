...
<title>Online ticket booking system | My Testimonials </title>
<!--Bootstrap -->
...
{ ?>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <p class="text-success">Active</p>

                  <div class="clearfix"></div>
                  </div>
                  <?php } else {?>
               <div class="vehicle_status"> <p class="text-danger">Pending</p>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
