...
<head>
  ...
  <title>Alpha Express | Car Listing</title>
  <!--Bootstrap -->
            ...
            foreach ($results as $result) {  ?>
              <div class="product-listing-m gray-bg">
                ...
                <div class="product-listing-content">
                  ...
                  <p class="list-price">$<?php echo htmlentities($result->PricePerDay); ?> /ticket</p>
                  <ul>
        ...
        <aside class="col-md-3 col-md-pull-9">
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-filter" aria-hidden="true"></i> Find Your desirable Destination </h5>
            </div>
            <div class="sidebar_filter">
              <form action="search-carresult.php" method="post">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Destinations</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Listed Destinations</h5>
            </div>
