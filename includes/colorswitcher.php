                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="predefined_styles">
                        <div class="skin-theme-switcher">
                            <h4>Color</h4>
                            <a href="#" data-switchcolor="green" class="styleswitch" style="background-color:#00a652;"> </a>
                            ...
                            <a href="#" data-switchcolor="red" class="styleswitch" style="background-color:#f80000;"> </a>
